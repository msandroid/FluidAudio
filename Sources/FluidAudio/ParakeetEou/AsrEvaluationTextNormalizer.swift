...
public struct AsrEvaluationTextNormalizer {
    ...
    private static let britishToAmerican: [String: String] = {
        // english.json is bundled in FluidAudioCLI; not available when used as a library.
        let bundles = [Bundle.main] + Bundle.allBundles + Bundle.allFrameworks
        for bundle in bundles {
            guard let url = bundle.url(forResource: "english", withExtension: "json"),
    ...
    public static func basicNormalize(_ text: String, removeDiacritics: Bool = false) -> String {
